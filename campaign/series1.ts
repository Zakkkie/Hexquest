...
export const series1Levels: LevelConfig[] = [
  // 1.0: Basic Level
  {
    ...
    description: 'Обучение азам. Цель: следуйте указаниям и достигните финиша.',
  ...
  // 1.1: Протокол Движения / Movement & Staircase Rule
  {
    ...
    description: 'Изучите правила перемещения по возвышенностям ландшафта.',
    goalText: 'Доберитесь до верхнего портала',
    mapConfig: {
      size: 4,
      type: 'fixed',
      customLayout: [
  ...
  // 1.4: Строительство и Фундамент / Upgrading & Support
  {
    ...
    description: 'Постройте боковые опорные площадки перед подъемом центральной плиты.',
    goalText: 'Возведите башню высокого уровня в центре',
    mapConfig: {
      size: 2,
      type: 'fixed',
      customLayout: [
  ...
  // 1.5: Жесткие Опоры
  {
    ...
    description: 'Создайте широкое опорное плато из смежных блоков, чтобы поднять центр.',
    goalText: 'Улучшите центральный сектор',
    mapConfig: {
      size: 2,
      type: 'fixed',
      customLayout: [
  ...
  // 1.7: Усталость и Логика Шагов / Energy, Fatigue & Emergency conversion
  {
    ...
    description: 'Преодолейте зоны высокой усталости и переместитесь в Столицу с помощью Void Core.',
    goalText: 'Доберитесь до Столицы',
    mapConfig: {
      size: 4,
      type: 'fixed',
  ...
  // 1.8: Глубинное Бурение / Deep Mines & Negative Levels
  {
    ...
    description: 'Постройте глубокую центральную шахту, укрепляя окружающий ландшафт.',
    goalText: 'Выкопайте глубокую шахту в центре',
    mapConfig: {
      size: 2,
      type: 'fixed',
      customLayout: [
  ...
  // 1.9: Заживление Пустот / Sealing Spacetime Voids
  {
    ...
    description: 'Примените Reality Patch из инвентаря для заживления пространственного разрыва.',
    goalText: 'Запечатайте пространственный разлом',
    mapConfig: {
      size: 2,
      type: 'fixed',
      customLayout: [
