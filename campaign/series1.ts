...
export const series1Levels: LevelConfig[] = [
  // 1.0: Basic Level & Height Snail (Merged)
  {
    ...
    mapConfig: {
      ...
      customLayout: [
        ...
        // --- COSMIC OCEAN DECORATIVE SHELF (FRAMING INTENT) ---
        // Beautiful dark deep rifts bordering the floating tutorial spine
        ...
        // Outer rings around the snail spiral (shading from deep -3 to abyssal -6)
  ...
  // 1.3: Архитектура Опор / Support Architecture (Merged 1.4 & 1.5)
  {
    id: '1.3',
  ...
  // 1.4: Съем энергии и Реакторы / Recovery Energy & Reactors (Formerly 1.6)
  {
    id: '1.4',
  ...
  // 1.5: Крах и Регенерация / Collapse & Regeneration (Merged 1.8 & 1.9)
  {
    id: '1.5',
  ...
  // 1.7: Секторный Монумент / Monument Blueprint Sequences (Formerly 1.10)
  {
    id: '1.7',
