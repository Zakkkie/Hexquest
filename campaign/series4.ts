...
export const series4Levels: LevelConfig[] = [
  // 4.1: Первая Кровь
  {
    ...
    startState: { credits: 0, moves: 12, rank: 2, materials: 2, initialEntropy: 0 },
  ...
  // 4.2: Оборона Высот
  {
    ...
    startState: { credits: 10, moves: 12, rank: 4, materials: 1 },
  ...
  // 4.3: Вражеская Архитектура
  {
    ...
    startState: { credits: 0, moves: 10, rank: 5, materials: 1 },
  ...
  // 4.4: Захват Монолита
  {
    ...
    startState: { credits: 10, moves: 12, rank: 5, materials: 1 },
  ...
  // 4.5: Чертеж в Тумане
  {
    ...
    startState: { credits: 20, moves: 12, rank: 2, materials: 2 },
  ...
  // 4.7: Гонка на Выживание
  {
    ...
    mapConfig: { size: 5, type: 'procedural' },
    startState: { credits: 20, moves: 12, rank: 3, materials: 1 },
  ...
  // 4.8: Осада
  {
    ...
    startState: { credits: 0, moves: 15, rank: 4, materials: 2 },
  ...
  // 4.11: Эскорт Ключа
  {
    ...
    startState: { credits: 35, moves: 12, rank: 5, materials: 1, startInventory: ['stability_scanner'] },
  ...
  // 4.13: Тектонический Резонанс
  {
    ...
    mapConfig: { size: 5, type: 'procedural' },
    startState: { credits: 30, moves: 12, rank: 3, materials: 2, initialEntropy: 80 },
  ...
  // 4.14: Ловушка Времени
  {
    ...
    startState: { credits: 10, moves: 10, rank: 2, materials: 1 },
  ...
  // 4.15: Захваченный Реактор
  {
    ...
    startState: { credits: 0, moves: 12, rank: 5, materials: 1 },
  ...
  // 4.18: Темное Ядро
  {
    ...
    objectiveHexes: [ { q: 0, r: 0, targetLevel: 5, label: 'Monument', color: 'emerald' } ],
    mapConfig: { size: 5, type: 'procedural', revealMode: 'fog' },
    startState: { credits: 30, moves: 12, rank: 5, materials: 1, startInventory: ['void_core'] },
  ...
  // 4.19: Гонка Резонанса
  {
    ...
    mapConfig: { size: 6, type: 'procedural' },
    startState: { credits: 40, moves: 15, rank: 5, materials: 2 },
  ...
  // 4.20: Автономный Фронт
  {
    ...
    startState: { credits: 50, moves: 20, rank: 5, materials: 3, startInventory: ['apex_core', 'architect_nanites'] },
