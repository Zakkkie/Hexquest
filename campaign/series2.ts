...
export const series2Levels: LevelConfig[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    description: 'ВВЕДЕНИЕ ОБЕЛИСКОВ:\n\nЗадача: Получите защитный ключ от Обелиска (Мини-монумента на координатах 1,2) и используйте его для активации центрального Монолита (0,0).\n\nЦель: Встаньте на Обелиск (1,2) и Активируйте его. Это подсветит тайник на (-1,3). Проведите глубокие раскопки на (-1,3) до уровня -1, заберите Ключ и активируйте центральный Монолит.\n\nУСЛОВИЕ ПРОИГРЫША: Вы застряли.',
    mapConfig: {
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    description: 'ВЕНЕЦ ИСПЫТАНИЯ НЕБУЛЫ:\n\nИнструкция:\n1. Активируйте 3 Обелиска (Мини-монумента) по краям карты. Это снимет защиту и укажет координаты секретных глубин ключей.\n2. Выстройте запечатывающее Кольцо (RING_6) из гексов Уровня 3 непосредственно вокруг центрального Монолита (0,0).\n3. Раскопайте указанные гексы до глубины -1 или ниже, соберите два ключа (Spent Fuel Cell и Reality Patch).\n4. Зайдите на центральный Монолит, вставьте ключи и нажмите АКТИВИРОВАТЬ!\n\nУСЛОВИЕ ПОРАЖЕНИЯ: Вы полностью застряли.',
    mapConfig: {
