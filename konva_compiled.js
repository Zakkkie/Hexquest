  ...
  "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    ...
    module.exports = function($$$config) {
      ...
      function popHostContext(fiber) {
        ...
        hostTransitionProviderCursor.current === fiber && (pop(hostTransitionProviderCursor, fiber), isPrimaryRenderer2 ? HostTransitionContext2._currentValue = NotPendingTransition2 : HostTransitionContext2._currentValue2 = NotPendingTransition2);
      }
      ...
      function propagateParentContextChanges(current2, workInProgress2, renderLanes2, forcePropagateEntireTree) {
        ...
        for (var parent = workInProgress2, isInsidePropagationBailout = false; null !== parent; ) {
          ...
          if (10 === parent.tag) {
            ...
            if (null === currentParent)
              throw Error("Should have a current fiber. This is a bug in React.");
            currentParent.memoizedState.memoizedState !== parent.memoizedState.memoizedState && (null !== current2 ? current2.push(HostTransitionContext2) : current2 = [HostTransitionContext2]);
          }
          parent = parent.return;
        }
      ...
      function startHostActionTimer(fiber) {
        if (0 > blockingUpdateTime) {
          ...
          var newEventTime = resolveEventTimeStamp2(), newEventType = resolveEventType2();
      ...
      function processRootScheduleInImmediateTask() {
        trackSchedulerEvent2();
        processRootScheduleInMicrotask();
      }
      function processRootScheduleInMicrotask() {
        mightHavePendingSyncWork = didScheduleMicrotask_act = didScheduleMicrotask = false;
        var syncTransitionLanes = 0;
        0 !== currentEventTransitionLane && shouldAttemptEagerTransition2() && (syncTransitionLanes = currentEventTransitionLane);
      ...
      function startTransition(fiber, queue, pendingState, finishedState, callback) {
        ...
        try {
          ...
          setCurrentUpdatePriority2(previousPriority), null !== prevTransition && null !== currentTransition.types && (null !== prevTransition.types && prevTransition.types !== currentTransition.types && console.error(
            "We expected inner Transitions to have transferred the outer types set and that you cannot add to the outer Transition while inside the inner.This is a bug in React."
...
+ <Activity %s>`,
      ...
      function updateActivityComponent(current2, workInProgress2, renderLanes2) {
        ...
        if (null !== prevState) {
          ...
          if (didSuspend)
            ...
            current2 = prevState.treeContext, supportsHydration2 && (nextHydratableInstance = getFirstHydratableChildWithinActivityInstance(
              activityInstance
      ...
      function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
        ...
        if (null !== prevState && (nextPrimaryChildren = prevState.dehydrated, null !== nextPrimaryChildren)) {
          if (didSuspend)
            ...
            isSuspenseInstancePending(nextPrimaryChildren) ? (workInProgress2.flags |= 192, workInProgress2.child = current2.child, workInProgress2 = null) : (current2 = prevState.treeContext, supportsHydration2 && (nextHydratableInstance = getFirstHydratableChildWithinSuspenseInstance(
              nextPrimaryChildren
        ...
        if (showFallback)
          return reuseSuspenseHandlerOnStack(workInProgress2), nextPrimaryChildren = nextProps.fallback, showFallback = workInProgress2.mode, prevState = current2.child, didSuspend = prevState.sibling, nextProps = createWorkInProgress(prevState, {
            ...
            renderLanes2,
            null
          ), nextPrimaryChildren.flags |= 2), nextPrimaryChildren.return = workInProgress2, nextProps.return = workInProgress2, nextProps.sibling = nextPrimaryChildren, workInProgress2.child = nextProps, bailoutOffscreenComponent(null, nextProps), nextProps = workInProgress2.child, nextPrimaryChildren = current2.child.memoizedState, null === nextPrimaryChildren ? nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes2) : (showFallback = nextPrimaryChildren.cachePool, null !== showFallback ? (prevState = isPrimaryRenderer2 ? CacheContext._currentValue : CacheContext._currentValue2, showFallback = showFallback.parent !== prevState ? { parent: prevState, pool: prevState } : showFallback) : showFallback = getSuspendedCache(), nextPrimaryChildren = {
        ...
        switch (workInProgress2.tag) {
          ...
          case 5:
            return null === current2 && isHydrating && (nextProps = getHostContext(), returnFiber = validateHydratableInstance(
              ...
              null,
              renderLanes2
            ), isPrimaryRenderer2 ? HostTransitionContext2._currentValue = prevSibling : HostTransitionContext2._currentValue2 = prevSibling), markRef(current2, workInProgress2), reconcileChildren(
              current2,
              workInProgress2,
              returnFiber,
              renderLanes2
      ...
      function markCloned(workInProgress2) {
        supportsPersistence2 && (workInProgress2.flags |= 8);
      }
      ...
      function updateHostComponent(current2, workInProgress2, type, newProps) {
        if (supportsMutation2)
          ...
          if ((current2 = doesRequireClone(current2, workInProgress2)) || _oldProps !== newProps) {
            ...
            _oldProps === currentInstance ? workInProgress2.stateNode = currentInstance : (markCloned(workInProgress2), finalizeInitialChildren2(
              _oldProps,
              type,
              newProps,
              currentHostContext
      ...
      function preloadInstanceAndSuspendIfNeeded(workInProgress2, type, oldProps, newProps, renderLanes2) {
        if ((workInProgress2.mode & 32) !== NoMode && (null === oldProps ? maySuspendCommit2(type, newProps) : maySuspendCommitOnUpdate(type, oldProps, newProps))) {
          if (workInProgress2.flags |= 16777216, (renderLanes2 & 335544128) === renderLanes2 || maySuspendCommitInSyncRender(type, newProps))
            if (preloadInstance2(workInProgress2.stateNode, type, newProps))
          ...
          case 26:
            if (supportsResources) {
              ...
              null === current2 ? (markUpdate(workInProgress2), null !== nextResource ? (bubbleProperties(workInProgress2), preloadResourceAndSuspendIfNeeded(
                ...
                workInProgress2,
                nextResource
              )) : (bubbleProperties(workInProgress2), workInProgress2.flags &= -16777217) : (nextResource = current2.memoizedProps, supportsMutation2 ? nextResource !== newProps && markUpdate(workInProgress2) : updateHostComponent(
                current2,
                workInProgress2,
                type,
                newProps
          ...
          case 27:
            if (supportsSingletons) {
              ...
              if (null !== current2 && null != workInProgress2.stateNode)
                supportsMutation2 ? current2.memoizedProps !== newProps && markUpdate(workInProgress2) : updateHostComponent(current2, workInProgress2, type, newProps);
              else {
                if (!newProps) {
                  if (null === workInProgress2.stateNode)
                    throw Error(
          ...
          case 5:
            ...
            if (null !== current2 && null != workInProgress2.stateNode)
              ...
              if (popHydrationState(workInProgress2))
                ...
                _rootContainerInstance = createInstance2(
                  type,
                  newProps,
          ...
          case 6:
            if (current2 && null != workInProgress2.stateNode)
              renderLanes2 = current2.memoizedProps, supportsMutation2 ? renderLanes2 !== newProps && markUpdate(workInProgress2) : supportsPersistence2 && (renderLanes2 !== newProps ? (current2 = requiredContext(
                rootInstanceStackCursor.current
              ), renderLanes2 = getHostContext(), markCloned(workInProgress2), workInProgress2.stateNode = createTextInstance2(
                newProps,
                current2,
                renderLanes2,
                workInProgress2
              ...
              if (popHydrationState(workInProgress2)) {
                ...
                markCloned(workInProgress2), workInProgress2.stateNode = createTextInstance2(
                  newProps,
                  current2,
                  renderLanes2,
                  workInProgress2
      ...
      function commitActivityHydrationCallbacks(finishedRoot, finishedWork) {
        if (supportsHydration2 && null === finishedWork.memoizedState && (finishedRoot = finishedWork.alternate, null !== finishedRoot && (finishedRoot = finishedRoot.memoizedState, null !== finishedRoot))) {
        ...
        switch (finishedWork.tag) {
          ...
          case 5:
            ...
            if (supportsMutation2) {
              ...
              supportsPersistence2 && null !== finishedWork.alternate && (finishedWork.alternate.stateNode = finishedWork.stateNode);
            break;
          case 6:
            recursivelyTraverseMutationEffects(root, finishedWork);
            commitReconciliationEffects(finishedWork);
          ...
          case 26:
            ...
            if (fiber.flags & suspenseyCommitFlag)
              if (null !== fiber.memoizedState)
                ...
                ((committedLanes & 335544128) === committedLanes || maySuspendCommitInSyncRender(type, fiber)) && suspendInstance2(suspendedState, instance, type, fiber);
              }
            break;
          case 5:
            recursivelyAccumulateSuspenseyCommit(
            ...
            fiber.flags & suspenseyCommitFlag && (instance = fiber.stateNode, type = fiber.type, fiber = fiber.memoizedProps, ((committedLanes & 335544128) === committedLanes || maySuspendCommitInSyncRender(type, fiber)) && suspendInstance2(suspendedState, instance, type, fiber));
            break;
          case 3:
          case 4:
      ...
      function requestUpdateLane(fiber) {
        ...
        return null !== transition ? (transition._updatedFibers || (transition._updatedFibers = /* @__PURE__ */ new Set()), transition._updatedFibers.add(fiber), requestTransitionLane()) : resolveUpdatePriority2();
      }
            ...
            if (startTime === RootErrored) {
              ...
              if (0 !== errorRetryLanes) {
                ...
                a: {
                  ...
                  var wasRootDehydrated = supportsHydration2 && yieldedFiber.current.memoizedState.isDehydrated;
            ...
            a: {
              ...
              if (null !== ReactSharedInternals.actQueue)
                ...
                if ((lanes & 62914560) === lanes && (renderWasConcurrent = globalMostRecentFallbackTime + FALLBACK_THROTTLE_MS - now$1(), 10 < renderWasConcurrent)) {
                  ...
                  forceSync.timeoutHandle = scheduleTimeout2(
      ...
      function commitRootWhenReady(root, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if (subtreeFlags & 8192 || 16785408 === (subtreeFlags & 16785408)) {
          if (suspendedState = startSuspendingCommit2(), accumulateSuspenseyCommitOnFiber(finishedWork, lanes, suspendedState), subtreeFlags = (lanes & 62914560) === lanes ? globalMostRecentFallbackTime - now$1() : (lanes & 4194048) === lanes ? globalMostRecentTransitionTime - now$1() : 0, subtreeFlags = waitForCommitToBeReady2(suspendedState, subtreeFlags), null !== subtreeFlags) {
            pendingEffectsLanes = lanes;
      ...
      function prepareFreshStack(root, lanes) {
        ...
        previousRenderStartTime !== noTimeout2 && (root.timeoutHandle = noTimeout2, cancelTimeout2(previousRenderStartTime));
                ...
                case SuspendedOnInstanceAndReadyToContinue:
                  ...
                  switch (workInProgress.tag) {
                    ...
                    case 27:
                      ...
                      if (resource ? preloadResource(resource) : preloadInstance2(hostFiber.stateNode, type, props)) {
                        workInProgressSuspendedReason = NotSuspended;
                        workInProgressThrownValue = null;
      ...
      function flushMutationEffects() {
        if (pendingEffectsStatus === PENDING_MUTATION_PHASE) {
          ...
          if (0 !== (finishedWork.subtreeFlags & 13878) || rootMutationHasEffect) {
            ...
            executionContext |= CommitContext;
            try {
              inProgressLanes = lanes, inProgressRoot = root, resetComponentEffectTimers(), commitMutationEffectsOnFiber(finishedWork, root), inProgressRoot = inProgressLanes = null, resetAfterCommit2(root.containerInfo);
            } finally {
      ...
      function flushLayoutEffects() {
        if (pendingEffectsStatus === PENDING_LAYOUT_PHASE) {
          ...
          if (0 !== (startTime.subtreeFlags & 8772) || rootHasLayoutEffect) {
            ...
            ReactSharedInternals.T = null;
            var _previousPriority = getCurrentUpdatePriority2();
            setCurrentUpdatePriority2(2);
            ...
            try {
              ...
              executionContext = _prevExecutionContext, setCurrentUpdatePriority2(_previousPriority), ReactSharedInternals.T = rootHasLayoutEffect;
            }
          }
      ...
      function flushSpawnedWork() {
        if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
          ...
          supportsHydration2 && flushHydrationEvents();
...
var HostTransitionContext = import_react.default.createContext(null);
...
var StageWrap = (props) => {
  ...
  const destroyStage = () => {
    ...
    (_a = stage.current) == null ? void 0 : _a.destroy();
    stage.current = null;
  };
  import_react2.default.useLayoutEffect(() => {
...
var Stage = import_react2.default.forwardRef((props, ref) => {
