        ...
        choices: [
          {
            ...
            reward: { items: ['PILGRIM_TOKEN'], credits: 15 },
            penalty: { energy: 5 },
          },
        ],
      },
        ...
        choices: [
          {
            label: 'Взять',
            action: 'CLOSE',
            reward: { items: ['SUPPLIES', 'SUPPLIES'] },
            penalty: { credits: 20 },
          },
        ],
      },
        ...
        choices: [
          {
            ...
            action: 'CLOSE',
            reward: { items: ['SEALED_LETTER', 'EXILE_MARK'] },
        ...
        choices: [
          {
            ...
            action: 'CLOSE',
            setFlag: 'forest_elder_quest_done',
            reward: { items: ['ELDER_MAP', 'SCRAP'], credits: 40 },
          },
        ],
      },
      fight_fail: {
        ...
        choices: [
          {
            ...
            reward: { items: ['HEARTSTONE_MAP'], credits: 80, hp: 30 },
            penalty: { items: ['ELDER_MAP'] },
          },
        ],
      },
    },
