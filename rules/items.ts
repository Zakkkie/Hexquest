...
export const ITEM_REGISTRY: ItemDefinition[] = [
    ...
    },
    {
        idPrefix: 'city_pass',
        rarity: 'RARE',
        name: { EN: 'City Pass', RU: 'Городской Пропуск' },
        description: { EN: 'Allows exit from the city to the wastes.', RU: 'Позволяет выйти из города в пустоши.' },
        visualType: 'CHIP',
        visualColor: '#3b82f6',
        effectType: 'ADD_MOVES',
        effectValue: 0,
        effectLabel: { EN: 'Access Granted', RU: 'Доступ разрешен' },
        negativeEffectType: 'LOSE_CREDITS',
        negativeEffectValue: 0,
        negativeEffectLabel: { EN: '', RU: '' },
    },
