...
export const TEXT: Record<Language, Dictionary> = {
    ...
    RU: {
        ...
        CAMPAIGN: {
            ...
            LEVEL_2_2_DESC: 'Сканирование: Ключи под землей.\n\nЦЕЛЬ: Собрать 3 ЛЮБЫХ ПРЕДМЕТА. Встаньте на Монолит, вставьте их в слоты и нажмите АКТИВИРОВАТЬ.\n\nМетод: КОПАЙТЕ (Красная) ниже Ур.0. Каждый новый уровень глубины — шанс на лут (20% на -1, 30% на -2, 40% на -3...).\n\nПодсказка: Копка дает +Топливо и +Материалы. Вы получаете энергию, исследуя недра.',
