...
export const TEXT: Record<Language, Dictionary> = {
    EN: {
        ...
        CAMPAIGN: {
            ...
            LEVEL_2_5_DESC: 'FINAL TEST: Two hostiles converge.\n\nObjective: Collect 3 items and reach Core (L5) first.\n\nConditions: The map is huge but decaying. Deep digging (Lvl -3) is required to find Rare keys, but digging accelerates Entropy.\n\nSurvival: Do not let the bots capture the Core.',
            LEVEL_3_1_TITLE: 'Sim 3.1: The Bridge',
            LEVEL_3_1_DESC: 'PUZZLE: Path Construction.\n\nObjective: Reach the Monolith on the other side.\n\nProblem: A void chasm separates you and the target. Build a bridge of L1 sectors.\n\nConstraint: Materials are tight — mistakes are not allowed.',
            LEVEL_3_2_TITLE: 'Sim 3.2: The Harvest',
            LEVEL_3_2_DESC: 'PUZZLE: Resource Optimization.\n\nObjective: Accumulate 200 Credits in 3 minutes.\n\nCatch: Standing on a Mine for 3+ ticks DESTROYS it. Alternate between mines.\n\nWarning: Exceeding 520 also leads to failure.',
            LEVEL_3_3_TITLE: 'Sim 3.3: The Cascade',
            LEVEL_3_3_DESC: 'PUZZLE: Chain Reaction.\n\nObjective: Build a Level 3 sector at the peak.\n\nRule: Upgrading requires 2 neighbors of the SAME level. Plan upgrades in the correct order.\n\nResources: Exactly 14 Materials — no losses allowed.',
            LEVEL_3_4_TITLE: 'Sim 3.4: The Gauntlet',
            LEVEL_3_4_DESC: 'PUZZLE: Entropy Survival.\n\nObjective: Accumulate 100 Credits AND survive 20 moves.\n\nEntropy starts LOW and drops quickly. Use Recovery and items.\n\nStrategy: Alternate between recovery stations.',
            LEVEL_3_5_TITLE: 'Sim 3.5: The Heist',
            LEVEL_3_5_DESC: 'PUZZLE: Item Race.\n\nObjective: Collect 3 items and activate the Monument before the Rival.\n\nCatch: Items have negative effects — choose wisely.\n\nEntropy is low. Hurry, but don\'t be reckless.',
            LEVEL_3_6_TITLE: 'Sim 3.6: The Maze of Echoes',
            LEVEL_3_6_DESC: 'FINAL PUZZLE: Multi-objective Mastery.\n\nObjective: Achieve ALL simultaneously:\n  1. Own 3+ L2+ sectors\n  2. 150+ Credits\n  3. Activate Monument with 2 items\n\nTwo bots patrol the maze. Every 30s a new void appears.',
            LEVEL_3_7_TITLE: 'Sim 3.7: Twin Protocol',
            LEVEL_3_7_DESC: 'PUZZLE: Choose Your Path.\n\nObjective: Either 4 L3+ hexes, OR 250 Credits.\n\nTwo paths to victory. Choose one and commit to it.',
            ...
            LEVEL_4_1_DESC: 'PUZZLE: Harmonious Construction.\n\nObjective: Create a "Ring of Resonance" - upgrade 3 DIFFERENT hexes to the same level (Lvl 2) simultaneously.\n\nRule: All 3 hexes must be neighbors of the start.',
            ...
            LEVEL_4_6_DESC: 'PUZZLE: Chain Reaction.\n\nObjective: Trigger a "Cascade" - 10 Level 3 hexes.\n\nWhen reaching Lvl 3, a hex automatically upgrades Lvl 2 neighbors.',
            LEVEL_4_7_TITLE: 'Sim 4.7: Duality Engine',
            LEVEL_4_7_DESC: 'PUZZLE: Two Cores.\n\nObjective: Own a "Logic Core" (6+ L3 hexes) AND a "Power Block" (4+ L4 hexes).\n\nBalance resources between the two centers.',
            LEVEL_4_8_TITLE: 'Sim 4.8: Omega Synthesis',
            LEVEL_4_8_DESC: 'FINAL: Complete Mastery.\n\nObjective: Complete 4 phases:\n  1. Different landscapes (Lvl 0, 2, 3)\n  2. 800 Credits\n  3. Monument (Lvl 5)\n  4. Entropy < 60'
        },
        TOOLTIP: {
    ...
    RU: {
        ...
        HUD: {
            ...
            BRIEFING_DESC_TEMPLATE: "Доминируйте. Наберите Ранг {0} и {1} Кредитов.",
