...
export const TEXT: Record<Language, Dictionary> = {
    EN: {
        ...
        CAMPAIGN: {
            ...
            LEVEL_1_4_TITLE: 'Sim 1.4: Support Architecture',
            LEVEL_1_4_DESC: 'Raise the central plate to Level 3. Ensure supporting neighbors are established first.',
            LEVEL_1_5_TITLE: 'Sim 1.5: Collapse and Regeneration',
            LEVEL_1_5_DESC: 'Drill the center shaft down to Level -2 to find a Reality Patch. Use it to heal the spacetime void.',
            LEVEL_1_6_TITLE: 'Sim 1.6: Three Pillars of Reality',
            LEVEL_1_6_DESC: 'Reach the Capital on the 3rd pillar by finding Reality Patches at depth -2 and healing the Voids.',
            LEVEL_1_7_TITLE: 'Sim 1.7: Land Line Final',
            LEVEL_1_7_DESC: 'Establish a continuous straight line of 3 adjacent Level 2 tiles.',
    ...
    RU: {
        ...
        CAMPAIGN: {
            ...
            LEVEL_1_4_TITLE: 'Сим 1.4: Архитектура Опор',
            LEVEL_1_4_DESC: 'Поднимите высоту центрального гекса до уровня L3. Сначала подготовьте опорный фундамент вокруг.',
            LEVEL_1_5_TITLE: 'Сим 1.5: Крах и Регенерация',
            LEVEL_1_5_DESC: 'Пробурите центральную шахту до уровня -2, чтобы найти Reality Patch. Используйте его для исцеления пустоты.',
            LEVEL_1_6_TITLE: 'Сим 1.6: Три Столпа Реальности',
            LEVEL_1_6_DESC: 'Доберитесь до Столицы на 3-м столпе, добывая Reality Patches на глубине -2 и восстанавливая Бездны.',
            LEVEL_1_7_TITLE: 'Сим 1.7: Финал: Линия Суши',
            LEVEL_1_7_DESC: 'Создайте непрерывную прямую линию из 3 смежных плит уровня L2.',
