...
export const TEXT: Record<Language, Dictionary> = {
    EN: {
        ...
        CAMPAIGN: {
            ...
            LEVEL_2_1_DESC: 'Target: Unknown Spire.\n\nObjective: Stand on the Monolith (Center, L3).\n\nProblem: Direct path blocked by L4 wall. Find the +1 staircase along the left ridge.\n\nStart: Almost no fuel. Use RECOVERY on your start hex, MOVE away to reset, repeat.\n\nHint: RECHARGE converts 5 Credits → 1 Move.',
            LEVEL_2_2_TITLE: 'Sim 2.2: Buried Secrets',
            LEVEL_2_2_DESC: 'Scan: Activation Keys underground.\n\nObjective: Collect 3 items and stand on the Monolith.\n\nMethod: DIG (Red) below L0. Each new depth has loot chance (20% at -1, 30% at -2...).\n\nTip: Digging gives +Moves and +Material.',
            LEVEL_2_3_TITLE: 'Sim 2.3: Entropy Rising',
            LEVEL_2_3_DESC: 'ALERT: Sector unstable.\n\nObjective: Reach Monolith (L4) before collapse.\n\nMechanic: Each action drains 1 Entropy (start: 15). At 0 → shift.\n\nTwo paths: SHORT (4 actions) vs LONG (6 actions). Fewer actions = more stability.',
            LEVEL_2_4_TITLE: 'Sim 2.4: The Rivalry',
            LEVEL_2_4_DESC: 'Threat: Hostile unit approaching.\n\nObjective: Reach Monolith with 2+ items BEFORE the Rival.\n\nStart: Nearly empty. DIG sites for fuel and artifacts.\nRival arrives in ~14 actions.',
            LEVEL_2_5_TITLE: 'Sim 2.5: The Singularity',
            LEVEL_2_5_DESC: 'FINAL TEST: Two hostiles converge.\n\nObjective: Collect 3 items and reach Core (L5) first.\n\nStart: Near-empty. DIG deep for fuel + artifacts.\nTwo rivals approach in ~15 actions.\n\nTip: Deeper digs = more Moves + better loot.',
            LEVEL_3_1_TITLE: 'Sim 3.1: The Bridge',
            LEVEL_3_1_DESC: 'DANGER: Void anomalies ahead.\n\nObjective: Cross the Void Bridge to reach the Monolith.\n\nMechanic: Stand adjacent to VOID, sacrifice an ITEM to restore it.\nCommon: 25%, Uncommon: 40% success.\n\nYou have 4 items. 3 VOID gaps. Plan wisely.',
            LEVEL_3_2_TITLE: 'Sim 3.2: The Harvest',
            LEVEL_3_2_DESC: 'Protocol: Resource Extraction.\n\nObjective: Accumulate 200 Credits.\n\nMethods: RECOVERY on owned hexes, UPGRADE for income (+20cr at L2), DIG for Materials + Moves.\n\nBuild an economy: Dig → Upgrade → Recover → Repeat.',
            LEVEL_3_3_TITLE: 'Sim 3.3: The Cascade',
            LEVEL_3_3_DESC: 'Protocol: Vertical Construction.\n\nObjective: Upgrade center hex to Level 3.\n\nRule: L2+ needs 2 neighbors at SAME level.\n\nPlan: Dig → Build L1 foundations → L2 supports → Crown center L3.',
            LEVEL_3_4_TITLE: 'Sim 3.4: The Gauntlet',
            LEVEL_3_4_DESC: 'CRITICAL: Entropy cascade.\n\nObjective: 100 Credits AND survive 20 actions.\n\nHazard: Every 5 actions → Entropy Spike (−8). Start: 50/100.\n\nStrategy: Earn fast via Recovery. Don\'t waste actions.',
            LEVEL_3_5_TITLE: 'Sim 3.5: The Heist',
            LEVEL_3_5_DESC: 'STEALTH: Item Recovery.\n\nObjective: Collect 3 items and stand on Monument.\n\nHazard: Patrol bot circles perimeter.\n\nMethod: DIG edge sites for items. Deep digs = better odds.',
            LEVEL_3_6_TITLE: 'Sim 3.6: The Maze of Echoes',
            LEVEL_3_6_DESC: 'FINAL PUZZLE: Multi-objective.\n\nAchieve ALL:\n  1. Own 3+ hexes at L2+\n  2. 150+ Credits\n  3. Stand on Monument\n\nDig → Build → Recover → Advance.',
            LEVEL_3_7_TITLE: 'Sim 3.7: Twin Protocol',
            LEVEL_3_7_DESC: 'DUAL: Choose your victory.\n\nPath A (Engineer): Own 4 hexes at L3+.\nPath B (Economist): 250 Credits.\n\nBoth start from scratch. Commit to your strategy.',
            LEVEL_3_8_TITLE: 'Sim 3.8: Fractured Supply Line',
            LEVEL_3_8_DESC: 'FINAL EXAM: All systems.\n\nObjective: 2 hexes L3+, 200 Credits, Monument, 2 items.\n\nTurn limit: 45. Act fast.',
            LEVEL_4_1_TITLE: 'Sim 4.1: Resonance Protocol',
            LEVEL_4_1_DESC: 'Objective: Build 3 adjacent hexes to Level 2.\n\nRule: L2 needs 2 neighbors at L1. Plan build order.\n\nStart empty — Dig for materials first.',
            LEVEL_4_2_TITLE: 'Sim 4.2: Mirror Maze',
            LEVEL_4_2_DESC: 'Objective: Own BOTH (-2,0) and (2,0) at L1+.\n\nDirect east path blocked by VOID. Find detours or sacrifice items to restore.',
            LEVEL_4_3_TITLE: 'Sim 4.3: Recursion Engine',
            LEVEL_4_3_DESC: 'Objective: Build 2 hexes to Level 3.\n\nEach level requires 2 neighbors at same level.\nBuild wide before building tall.',
            LEVEL_4_4_TITLE: 'Sim 4.4: Thermal Equilibrium',
            LEVEL_4_4_DESC: 'Objective: Upgrade Center to L4.\n\nHazard: Each action adds +3 Entropy (start: 70/100).\nAt 100 → collapse. ~10 actions max.\n\nPre-built L2 staircase. Focus on upgrading.',
            LEVEL_4_5_TITLE: 'Sim 4.5: Convergence Point',
            LEVEL_4_5_DESC: 'RACE: Complete 2 of 3 goals BEFORE the Rival:\n  A) 5+ hexes at L2+\n  B) 200 Credits\n  C) Stand on Monument\n\nRival arrives in ~16 actions. Choose and commit.',
            LEVEL_4_6_TITLE: 'Sim 4.6: Cascade Protocol',
            LEVEL_4_6_DESC: 'Objective: 8+ hexes at Level 3.\n\nSpecial: When hex reaches L3, adjacent L2 hexes auto-upgrade to L3!\n\nStrategy: Build large L2 cluster, then trigger chain reaction.',
            LEVEL_4_7_TITLE: 'Sim 4.7: Duality Engine',
            LEVEL_4_7_DESC: 'Objective: Own 4 hexes at L3+ AND 2 hexes at L4+.\n\nChallenge: L4 needs Rank 3 and L3 neighbors.\nBuild wide AND tall from scratch.',
            LEVEL_4_8_TITLE: 'Sim 4.8: Omega Synthesis',
            LEVEL_4_8_DESC: 'ULTIMATE TRIAL.\n\nAchieve ALL:\n  1. 3+ hexes at L3+\n  2. 300+ Credits\n  3. Stand on Monument with 2+ items\n\nEntropy: +2/action. Start: 50/100. ~25 actions max.'
        },
        TOOLTIP: {
    ...
    RU: {
        ...
        CAMPAIGN: {
            ...
            LEVEL_2_1_DESC: 'Цель: Неизвестный Шпиль.\n\nЦЕЛЬ: Встать на Монолит (Центр, Ур.3).\n\nПроблема: Прямой путь блокирован стеной Ур.4. Найдите лестницу +1 вдоль левого хребта.\n\nСтарт: Почти без топлива. Используйте ВОССТАНОВЛЕНИЕ, затем УЙДИТЕ и ВЕРНИТЕСЬ для сброса.\n\nПодсказка: ДОЗАПРАВКА = 5 Кредитов → 1 Ход.',
            LEVEL_2_2_TITLE: 'Сим 2.2: Тайны Недр',
            LEVEL_2_2_DESC: 'Сканирование: Ключи под землей.\n\nЦЕЛЬ: Собрать 3 предмета и встать на Монолит.\n\nМетод: КОПАЙТЕ (Красная) ниже Ур.0. Каждый новый уровень глубины — шанс на лут (20% на -1, 30% на -2...).\n\nПодсказка: Копка дает +Ходы и +Материалы.',
            LEVEL_2_3_TITLE: 'Сим 2.3: Рост Энтропии',
            LEVEL_2_3_DESC: 'ВНИМАНИЕ: Сектор нестабилен.\n\nЦЕЛЬ: Достичь Монолита (Ур.4) до коллапса.\n\nМеханика: Каждое действие тратит 1 Энтропию (старт: 15). При 0 → катастрофа.\n\nДва пути: КОРОТКИЙ (4 действия) vs ДЛИННЫЙ (6 действий). Меньше действий = больше стабильности.',
            LEVEL_2_4_TITLE: 'Сим 2.4: Противостояние',
            LEVEL_2_4_DESC: 'Угроза: Враждебный юнит.\n\nЦЕЛЬ: Достичь Монолита с 2+ предметами раньше Соперника.\n\nСтарт: Почти пусто. КОПАЙТЕ участки на пути за топливо и артефакты.\nСоперник прибудет через ~14 действий.',
